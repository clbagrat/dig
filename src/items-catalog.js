...
export const ALL_ITEMS = [
  ...
  },
  {
    ...
    name: "Компас чертежа",
    icon: "🔮",
    desc: "Радары маяков показывают фиолетовый указатель на ближайший чертеж.",
    category: "алхимия",
    tags: ["алхимия"],
    minRarity: 3,
    maxRarity: 3,
    unique: true,
    effect: { stat: "blueprintRadarMode", value: 1 },
  },
  {
    id: "gold_fever",
    type: "item",
...
const SIMPLE_STAT_DESCRIPTORS = {
  ...
  blueprintRadarMode: () => t("desc.blueprintRadarMode"),
