...
export const SFX = {
  ...
  artifact_pickup: { id: "artifact_pickup", cat: "pickup",      desc: "Подбор чертежа", full: "Подбор чертежа. Значимый, весомый звук — низкий гонг или глубокий тон. Ощущение редкой находки." },
  ...
  artifact_drop:   { id: "artifact_drop",   cat: "damage",      desc: "Чертеж выпал при уроне", full: "Чертеж выпал из инвентаря при получении урона. Тяжёлый звон падения ценного предмета. Привлекает внимание — «ты потерял что-то важное»." },
  ...
  modal_open:      { id: "modal_open",      cat: "ui",          desc: "Открытие модального окна", full: "Открытие модального окна (уровень, перк, чертеж). Мягкий «вуш» появления. Лёгкий и ненавязчивый." },
