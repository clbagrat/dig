...
const STAT_DEFS = [
  ...
  { key: "weakSpotChance",             label: "Шанс слабого места",             shortLabel: "СМ%",    format: "percent" },
  { key: "weakSpotMult",               label: "Множитель слабого места",         shortLabel: "хСМ",    format: "multiplier" },
